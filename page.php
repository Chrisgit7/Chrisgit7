...
<html>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
          ...
          <h1 class="text" style="color:#015815a9;">CANACARE!!</h1>
      ...
      <div id="carouselExample" class="carousel slide">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="trimaellhniko.jpg" class="d-block w-50" alt="...">
          </div>
          <div class="carousel-item">
            <img src="cbdoil500.jpg" class="d-block w-50" alt="...">
          </div>
          <div class="carousel-item">
            <img src="bioprotein.jpg" class="d-block w-50" alt="...">
          </div>
          <div class="carousel-item">
            <img src="product10.jpg" class="d-block w-50" alt="...">
          </div>
        </div>
