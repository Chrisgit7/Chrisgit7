...
<body id="myPage">
    ...
    <div id="checkout-page" class="checkout-content">
        <!-- Άλλο περιεχόμενο της σελίδας Checkout -->
        <div class="cart-overlay transparentBcg">
            <div class="cart">
                ...
                <div class="cart-footer">
                    ...
                    <button id="continue_to_order" class="clear-cart banner-btn" style="margin-bottom:100px">Continue to Order</button>
                </div>
            </div>
        </div>
    </div>
